...
if NEW_TYPING:
    from typing import (Callable, ClassVar, ForwardRef, Generic, NewType,
                        Tuple, TypeVar, Union, _GenericAlias)
    ...
    from typing import (Callable, CallableMeta, GenericMeta, Tuple, TupleMeta,
                        TypeVar, Union, _ForwardRef)
    try:
