...
from pydantic_core import (CoreSchema, PydanticUndefined, core_schema,
                           to_jsonable_python)
from typing_extensions import (Annotated, Literal, TypeAliasType, TypedDict,
...
from ._core_utils import (NEEDS_APPLY_DISCRIMINATED_UNION_METADATA_KEY,
                          CoreSchemaOrField, collect_invalid_schemas,
